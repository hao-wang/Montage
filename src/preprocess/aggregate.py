...
class Aggregator:
    ...
    def add_frag(self, node):
        ...
        # Existing fragment, but different hash -- when does that happen??
    ...
    def aggregate(self, ast_data):
        """
        Assign idx to each fragment in _frag_seq & _frag_info_seq and make it numerical.
        ...
        for i, v in enumerate(ast_data):
            ...
            # Build dataset for additional features, i.e., parent frag's idx & type_idx
